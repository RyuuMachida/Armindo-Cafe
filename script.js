...
function processPaymentPending(method) {
  ...
  const newOrder = {
    ...
    proofUploaded:
      method === "qris" ? (currentOrderData.proofImage ? true : false) : true,
...
function rejectOrder(orderId) {
  ...
  showNotification(`Pesanan ${order.orderNumber} ditolak: ${reason}`, "info");
}
...
// Set initial title for password toggle
